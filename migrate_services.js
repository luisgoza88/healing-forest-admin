...
async function migrateServices() {
    ...
    const serviceConfigs = {
        ...
        'yoga': {
            ...
            allowWaitlist: true,
            operatingHours: {
                monday: { open: '06:00', close: '20:00', slots: ['06:00', '08:00', '10:00', '16:00', '18:00'] },
                tuesday: { open: '06:00', close: '20:00', slots: ['06:00', '08:00', '10:00', '16:00', '18:00'] },
                wednesday: { open: '06:00', close: '20:00', slots: ['06:00', '08:00', '10:00', '16:00', '18:00'] },
                thursday: { open: '06:00', close: '20:00', slots: ['06:00', '08:00', '10:00', '16:00', '18:00'] },
                friday: { open: '06:00', close: '20:00', slots: ['06:00', '08:00', '10:00', '16:00', '18:00'] },
                saturday: { open: '08:00', close: '14:00', slots: ['08:00', '10:00', '12:00'] },
                sunday: { open: '08:00', close: '14:00', slots: ['08:00', '10:00', '12:00'] }
            }
        },
    ...
    try {
        ...
        for (const doc of servicesSnapshot.docs) {
            ...
            if (config) {
                ...
                updateCount++;
                console.log(`Updating ${service.name} with capacity configuration`);
            } else {
                ...
                console.log(`Setting default configuration for ${service.name}`);
            }
        }
        ...
        console.log(`Migration completed! Updated ${updateCount} services with capacity management.`);
        ...
        console.log('Schedule templates created successfully!');
...
async function createScheduleTemplate(serviceKey, config) {
    ...
    for (let i = 0; i < daysOfWeek.length; i++) {
        ...
        if (dayConfig && dayConfig.open) {
            ...
            const existing = await db.collection('service_schedules')
            ...
            if (existing.empty) {
                ...
                console.log(`Created schedule template for ${serviceKey} on ${day}`);
            }
        }
    }
}
...
console.log('Migration script loaded. Run migrateServices() to start.');